...
@REM This downloads the transcript of a video i think
...
yt-dlp -P %DownloadLocation% --sponsorblock-remove all --write-sub --write-auto-sub --sub-lang "en.*" --sub-format ttml --convert-subs srt --skip-download  %url% || pause
timeout /t 5